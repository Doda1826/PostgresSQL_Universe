...
INSERT INTO public.description VALUES (2, 'Andromeda Galaxy', 'Andromeda is the closest big galaxy to the Milky Way.', 1);
...
SELECT pg_catalog.setval('public.description_of_every_celestial_body_celestial_body_id_seq', 2, true);
...
--
-- Name: moon moon_celestial_body_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moon_celestial_body_id_key UNIQUE (celestial_body_id);
...
--
-- Name: planet planet_celestial_body_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.planet
    ADD CONSTRAINT planet_celestial_body_id_key UNIQUE (celestial_body_id);
...
--
-- Name: star star_celestial_body_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT star_celestial_body_id_key UNIQUE (celestial_body_id);
...
--
-- Name: moon moon_celestial_body_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.moon
    ADD CONSTRAINT moon_celestial_body_id_fkey FOREIGN KEY (celestial_body_id) REFERENCES public.planet(celestial_body_id);


--
-- Name: planet planet_celestial_body_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.planet
    ADD CONSTRAINT planet_celestial_body_id_fkey FOREIGN KEY (celestial_body_id) REFERENCES public.star(celestial_body_id);


--
-- Name: star star_celestial_body_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT star_celestial_body_id_fkey FOREIGN KEY (celestial_body_id) REFERENCES public.galaxy(celestial_body_id);
